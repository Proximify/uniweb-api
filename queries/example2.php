 ...
 * of the "interest" field. The interests are hierarchical and there can be duplicate names.
 ...
 * hierarchy should be specified. For the second interest, 'Experts Systems', we will
